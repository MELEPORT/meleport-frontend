...
function Profile() {
            ...
            if (price && currentToken.token_id) {
                ...
                if (storageAccount > 0) {
                    ...
                    notification["warning"]({
                        ...
                        description:
                            'Your Storage Balance is not enough to post a new NFT for sale. Please top up at the Storage Deposit button!',
                    });
                }
            }
    ...
    async function handleStorageDeposit() {
        ...
        <div>
            <PageHeader
                ...
                extra={[
                    ...
                    <Button onClick={() => handleStorageDeposit()}>Storage Deposit</Button>,
                ]}
            />
